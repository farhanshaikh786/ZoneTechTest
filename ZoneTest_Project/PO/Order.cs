...
namespace ZoneTest_Project.PO
{
    public class Order
    {
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='block_top_menu']/ul/li[3]/a")] private IWebElement Tshirt;
        [FindsBy(How = How.XPath, Using = "//*[@id='header_logo']/a/img")] private IWebElement Logo;

        [FindsBy(How = How.XPath, Using = "//*[@id='homefeatured']/li[3]/div/div[1]/div/a[1]/img")] private IWebElement Print;
        [FindsBy(How = How.XPath, Using = "//*[@id='add_to_cart']")] private IWebElement Chart;
